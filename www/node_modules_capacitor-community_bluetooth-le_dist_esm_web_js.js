...
function _runWithTimeout() {
  _runWithTimeout = (0,_Users_apple_Documents_Projects_TestBluetooth_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (promise, time, exception) {
    let timer;
...
/* harmony import */ var _timeout__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./timeout */ 5196);
...
class BluetoothLeWeb extends _capacitor_core__WEBPACK_IMPORTED_MODULE_1__.WebPlugin {
  ...
  requestLEScan(options) {
    ...
    return (0,_Users_apple_Documents_Projects_TestBluetooth_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      navigator.bluetooth.removeEventListener('advertisementreceived', _this9.onAdvertisementReceived);
      navigator.bluetooth.addEventListener('advertisementreceived', _this9.onAdvertisementReceived);
  ...
  onAdvertisementReceived(event) {
    var _a, _b; // do not use `this` in event listener
  ...
  connect(options) {
    ...
    return (0,_Users_apple_Documents_Projects_TestBluetooth_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      device.removeEventListener('gattserverdisconnected', _this13.onDisconnected);
      device.addEventListener('gattserverdisconnected', _this13.onDisconnected);
  ...
  startNotifications(options) {
    ...
    return (0,_Users_apple_Documents_Projects_TestBluetooth_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      characteristic === null || characteristic === void 0 ? void 0 : characteristic.removeEventListener('characteristicvaluechanged', _this26.onCharacteristicValueChanged);
      characteristic === null || characteristic === void 0 ? void 0 : characteristic.addEventListener('characteristicvaluechanged', _this26.onCharacteristicValueChanged);
